    ...
    return(
        <div>
            <div className='uk-inline'>
                <img className={`uk-border-circle uk-box-shadow-small ${swapIn ? 'fantasy-border-success' : 'fantasy-border-danger'}`} width='175' src={`https://assets.nhle.com/mugs/nhl/20192020/${team}/${id}.png`} alt={name}/>
