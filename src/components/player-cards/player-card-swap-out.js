    ...
    return(
        <div>
            <div className='uk-inline'>
                <img className={`uk-border-circle uk-box-shadow-small cursor-pointer ${selected ? 'fantasy-border-danger' : ''}`} width='175' src={`https://assets.nhle.com/mugs/nhl/20202021/${team}/${id}.png`} alt={name} onClick={onClick}/>
