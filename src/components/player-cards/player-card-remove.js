    ...
    return(
        <div>
            ...
            <div className='uk-inline'>
                <img className='uk-border-circle uk-box-shadow-small uk-box-shadow-hover-xlarge cursor-pointer' width='175' height='175' src={`https://assets.nhle.com/mugs/nhl/20192020/${team}/${id}.png`} alt={name}/>
